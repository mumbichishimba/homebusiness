...
<html>
    ...
    <body class="sidebar-mini skin-green-light wysihtml5-supported">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">Delete Farm</div>
            <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                <form:form modelAttribute="farm" method="POST" commandName="farm"  cssClass="form-horizontal" >
                    <div class="form-group">
                        <div class="form-line">
                            <input name="name" class="form-control"  value="${farm.name}" placeholder="Name" id="name">
                        </div>
                    </div> 
                    <div class="form-group">
                        <div class="form-line">
                            <input name="town" class="form-control"  value="${farm.town}" placeholder="Town" id="town">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input name="location" class="form-control" value="${farm.location}" placeholder="Location" id="location">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input name="price" class="form-control" value="${farm.price}" placeholder="Price" id="price">
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-danger"> Yes</button>
                        <a href="/homebusiness/farm/home.html" class="btn btn-success"> No</a>
                    </div>
                </form:form>
            </div>
        </div>
