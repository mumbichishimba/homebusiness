    ...
    <body class="sidebar-mini skin-green-light wysihtml5-supported">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                ...
                <form:form modelAttribute="farmSale" method="POST" commandName="farmSale"  cssClass="form-horizontal" >
                    <div class="form-group">
                        <div class="form-line">
                            <input name="dateOfSales" class="form-control" placeholder="Date of Sale" id="dateOfSales">
                        </div>
                    </div> 
                    <div class="form-group">
                        <div class="form-line">
                            <input name="description" class="form-control" placeholder="Description" id="description">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
