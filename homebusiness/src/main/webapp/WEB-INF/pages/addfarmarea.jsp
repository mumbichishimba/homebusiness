        ...
        <div class="box box-primary">
            ...
            <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                ...
                <form:form modelAttribute="farmArea" method="POST" commandName="farmArea"  cssClass="form-horizontal" >
                    <div class="form-group">
                        <div class="form-line">
                            <input name="primaryItem" class="form-control" placeholder="Primary Crop/Animal" id="primaryItem">
                        </div>
                    </div> 
                    <div class="form-group">
                        <div class="form-line">
                            <input name="lengthInMeters" class="form-control" placeholder="Length in Meters" id="lengthInMeters">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input name="breadthInMeters" class="form-control" placeholder="Breadth in Meters" id="breadthInMeters">
                        </div>
                    </div>
                    <div class="form-group">
