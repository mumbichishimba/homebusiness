                ...
                <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                        <form:form modelAttribute="busSale" method="POST" commandName="busSale" cssClass="form-horizontal" >
                            <div class="form-group">
                                ...
                                <input name="dateOfSale"  class="form-control" id="dateOfSale" value="<fmt:formatDate value="${busSale.dateOfSale}" pattern="MM/dd/yyyy"></fmt:formatDate>" />
                                </div>
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <input name="description" value="${busSale.description}" class="form-control" id="description"/>
                            </div> 
                            <div class="form-group">
                                <label for="amount">Amount</label>
                                <div class="input-group">
                                    <span class="input-group-addon" id="basic-addon1">K</span>
                                    <input name="amount" value="${busSale.amount}" class="form-control" id="amount"/>
                                </div>
                            </div>
                            <div class="form-group">
