                ...
                <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                        ...
                        <form:form modelAttribute="bus" method="POST" commandName="bus" cssClass="form-horizontal" >
                            ...
                            <div class="form-group">
                                ...
                                <input name="busType" class="form-control" id="busType">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="numberplate" class="form-control" id="numberplate">
                            </div>
                            <div class="form-group">
                                <label for="originalCost">Original Cost</label>
                                <input name="originalCost" class="form-control" id="originalCost">
                            </div>
                            <div class="form-group">
                                <label for="dateOfPurchase">Date of Purchase</label>
                                <input name="dateOfPurchase" class="form-control" id="dateOfPurchase">
                            </div>
                            <!---
                            <div class="form-group">
