...
<html>
    ...
    <body class="sidebar-mini skin-green-light wysihtml5-supported">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">Are you sure you want to delete this Farm Area?</div>
            <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                ...
                <form:form modelAttribute="farmArea" method="POST" commandName="farmArea"  cssClass="form-horizontal" >
                    <div class="form-group">
                        <div class="form-line">
                            <input readonly="" name="primaryItem" class="form-control" value="${farmArea.primaryItem}" placeholder="Primary Crop/Animal" id="primaryItem">
                        </div>
                    </div> 
                    <div class="form-group">
                        <div class="form-line">
                            <input readonly=""  name="lengthInMeters" class="form-control" value="${farmArea.lengthInMeters}" placeholder="Length in Meters" id="lengthInMeters">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input readonly=""  name="breadthInMeters" class="form-control" value="${farmArea.breadthInMeters}" placeholder="Breadth in Meters" id="breadthInMeters">
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-danger">Yes</button>
                        <a href="/homebusiness/farm/${farmArea.farmId}/viewfarm.html" class="btn btn-success"> No</a>
                    </div>
                </form:form>
            </div>
        </div>
