...
<html>
    ...
    <body class="sidebar-mini skin-green-light wysihtml5-supported">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">View Farm Expenses</div>
            <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <c:forEach var="farmExpenses" items="${farmExpenses}">
                            <tr>
                                <td>${farmExpenses.expenseName}</td>
                                <td>${farmExpenses.expenseType}</td>
                                <td>${farmExpenses.amount}</td>
                                <td>
                                    <a class="btn btn-warning" href="/homebusiness/farm/${farmExpenses.id}/expense/edit.html"><span class="glyphicon glyphicon-edit" ></span>&nbsp;Edit</a>&nbsp;|&nbsp;
                                    <a class="btn btn-danger" href="/homebusiness/farm/${farmExpenses.id}/expense/delete.html"><span class="glyphicon glyphicon-remove-circle" ></span>&nbsp;Delete</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
                <a class="btn btn-success" href="/homebusiness/farm/${farm.id}/expense/add.html?id=${farm.id}">+&nbsp;Add Expense</a>
            </div>
        </div>
        <br/>
        <br/>
