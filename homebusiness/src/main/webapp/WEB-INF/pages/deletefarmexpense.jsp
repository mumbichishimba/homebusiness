        ...
        <div class="box box-primary">
            ...
            <div class="box-body" style="padding-left: 5%;padding-right: 5%;">
                ...
                <form:form modelAttribute="farmExpense" method="POST" commandName="farmExpense"  cssClass="form-horizontal" >
                    <div class="form-group">
                        <div class="form-line">
                            <input name="expenseName" readonly="" value="${farmExpense.expenseName}" class="form-control" placeholder="Expense Name" id="expenseName">
                        </div>
                    </div> 
                    <div class="form-group">
                        <div class="form-line">
                            <input name="expenseType" readonly="" value="${farmExpense.expenseType}" class="form-control" placeholder="Expense Type" id="expenseType">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-line">
                            <input name="amount" readonly="" value="${farmExpense.amount}" class="form-control" placeholder="Amount" id="amount">
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-danger">Yes</button>
                        <a href="/homebusiness/farm/${farmExpense.farmId}/viewfarmexpenses.html" class="btn btn-success"> No</a>
                    </div>
                </form:form>
            </div>
        </div>
